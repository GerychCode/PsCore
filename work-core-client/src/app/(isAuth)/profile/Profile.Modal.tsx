...
const ProfileModal = ({ isModalOpen, setIsModalOpen }: any) => {
  ...
  const { mutateAsync, isPending: isProfileUpdating } = userUpdate(changedFields)
            ...
            >
              <div className='flex flex-row items-center justify-between gap-16'>
                ...
                <div className='flex flex-row gap-1'>
                  ...
                  <button
                      type='submit'
                      className='rounded-2xl border-2 border-gray-200 p-2.5 bg-primary text-white text-base font-medium hover:opacity-95 hover:shadow-sm disabled:opacity-50'
                      disabled={
              ...
              <div className='flex flex-col gap-3'>
                ...
                <div className='flex flex-row gap-3 items-center '>
                  ...
                  <div className='flex flex-row gap-3'>
                    <label
                        htmlFor='avatar'
                        className='inline-block cursor-pointer rounded-2xl border-2 border-gray-200 p-2.5 bg-primary text-white text-base font-medium hover:opacity-95 hover:shadow-sm disabled:opacity-20'
                    >
                      Обрати зображення
                    </label>
                    <input
