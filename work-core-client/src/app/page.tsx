...
import { FaArrowRight, FaCalendarAlt, FaChartLine } from 'react-icons/fa'
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center max-w-3xl mx-auto mt-10 md:mt-20'>
            ...
            <p className='mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl'>
              Система для автоматизації графіків, обліку змін та контролю
              співробітників. Простота для персоналу, потужна аналітика для
              керівників.
            </p>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12'>
              ...
              <div className='flex flex-col items-center text-center p-6 rounded-3xl bg-gray-50 border border-gray-100 hover:border-primary/20 transition duration-300'>
                ...
                <p className='text-gray-500 leading-relaxed'>
                  Створюйте та редагуйте робочі зміни в кілька кліків. Зручний
                  календарний вигляд для менеджерів та співробітників.
                </p>
              </div>
              ...
              <div className='flex flex-col items-center text-center p-6 rounded-3xl bg-gray-50 border border-gray-100 hover:border-primary/20 transition duration-300'>
                ...
                <p className='text-gray-500 leading-relaxed'>
                  Точна фіксація початку та кінця робочого дня. Автоматичний
                  підрахунок відпрацьованих годин та перерв.
                </p>
              </div>
              ...
              <div className='flex flex-col items-center text-center p-6 rounded-3xl bg-gray-50 border border-gray-100 hover:border-primary/20 transition duration-300'>
                ...
                <p className='text-gray-500 leading-relaxed'>
                  Генеруйте детальні звіти по кожному співробітнику. Контролюйте
                  запізнення та ефективність роботи відділень.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className='mt-24 md:mt-32 bg-primary rounded-3xl p-8 md:p-16 text-center text-white relative overflow-hidden mb-12'>
            <div className='relative z-10'>
              ...
              <p className='text-primary-100 text-lg mb-8 max-w-2xl mx-auto'>
                Приєднуйтесь до 2Work сьогодні та отримайте повний контроль над
                робочим процесом.
              </p>
      ...
      <footer className='bg-white border-t border-gray-100 py-8'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-4'>
          <div className='flex items-center gap-2 opacity-75'>
            <Image src='/logo.svg' alt='2Work Logo' width={24} height={24} />
